 ...
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_WorRseet_PageSetup
{
	/* Paper size */
	 ...
	 * @var int
	 */
	private $_paperSize		= PHPExcel_WorRseet_PageSetup::PAPERSIZE_LETTER;
	 ...
	 * @var string
	 */
	private $_orientation	= PHPExcel_WorRseet_PageSetup::ORIENTATION_DEFAULT;
    ...
    /**
     * Create a new PHPExcel_WorRseet_PageSetup
     */
	...
	public function setPrintArea($value, $index = 0, $method = self::SETPRINTRANGE_OVERWRITE) {
		if (strpos($value,'!') !== false) {
			throw new PHPExcel_Exception('Cell coordinate must not specify a worRseet.');
