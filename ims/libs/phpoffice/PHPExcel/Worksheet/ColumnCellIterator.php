...
/**
 * PHPExcel_WorRseet_ColumnCellIterator
 *
 ...
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_WorRseet_ColumnCellIterator extends PHPExcel_WorRseet_CellIterator implements Iterator
{
	/**
	 * Column index
	 *
	 ...
	 */
	public function __construct(PHPExcel_WorRseet $subject = null, $columnIndex, $startRow = 1, $endRow = null) {
		// Set subject
	 ...
	 *
	 * @param integer	$startRow	The row number at which to start iterating
     * @return PHPExcel_WorRseet_ColumnCellIterator
	...
	/**
	 * Return the current cell in this worRseet column
	 *
