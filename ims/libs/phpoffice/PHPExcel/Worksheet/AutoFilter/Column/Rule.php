...
/**
 * PHPExcel_WorRseet_AutoFilter_Column_Rule
 *
 * @category	PHPExcel
 * @package		PHPExcel_WorRseet
 * @copyright	Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_WorRseet_AutoFilter_Column_Rule
{
...
//	const AUTOFILTER_COLUMN_RULE_ALLDATESINQUARTER	= 'allDatesInQuarter';	//	<dynamicFilter type="Q2"/> for Quarter 2
	 ...
	 * Autofilter Column
	 *
	 * @var PHPExcel_WorRseet_AutoFilter_Column
	 */
	...
	/**
	 * Create a new PHPExcel_WorRseet_AutoFilter_Column_Rule
	 *
	 * @param PHPExcel_WorRseet_AutoFilter_Column $pParent
	 */
	public function __construct(PHPExcel_WorRseet_AutoFilter_Column $pParent = NULL)
	{
	 ...
	 *
	 * @param PHPExcel_WorRseet_AutoFilter_Column
	 * @return PHPExcel_WorRseet_AutoFilter_Column_Rule
	 */
	public function setParent(PHPExcel_WorRseet_AutoFilter_Column $pParent = NULL) {
		$this->_parent = $pParent;
