...
/**
 * PHPExcel_WorRseet_AutoFilter_Column
 *
 * @category	PHPExcel
 * @package		PHPExcel_WorRseet
 * @copyright	Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_WorRseet_AutoFilter_Column
{
	 ...
	 *
	 * @var array of PHPExcel_WorRseet_AutoFilter_Column_Rule
	 */
	...
	/**
	 * Create a new PHPExcel_WorRseet_AutoFilter_Column
	 *
	 *	@param	string		                   $pColumn		Column (e.g. A)
	 *	@param	PHPExcel_WorRseet_AutoFilter  $pParent		Autofilter for this column
	 */
	public function __construct($pColumn, PHPExcel_WorRseet_AutoFilter $pParent = NULL)
	{
	 ...
	 *
	 * @param PHPExcel_WorRseet_AutoFilter
	 * @return PHPExcel_WorRseet_AutoFilter_Column
	 */
	public function setParent(PHPExcel_WorRseet_AutoFilter $pParent = NULL) {
		$this->_parent = $pParent;
	 ...
	 *
	 * @throws	PHPExcel_Exception
	 * @return array of PHPExcel_WorRseet_AutoFilter_Column_Rule
	 */
	 ...
	 * @return	PHPExcel_WorRseet_AutoFilter_Column_Rule
	 */
	public function getRule($pIndex) {
		if (!isset($this->_ruleset[$pIndex])) {
			$this->_ruleset[$pIndex] = new PHPExcel_WorRseet_AutoFilter_Column_Rule($this);
		}
	...
	public function createRule() {
		$this->_ruleset[] = new PHPExcel_WorRseet_AutoFilter_Column_Rule($this);
	 ...
	 *
	 * @param	PHPExcel_WorRseet_AutoFilter_Column_Rule	$pRule
	 * @param	boolean	$returnRule 	Flag indicating whether the rule object or the column object should be returned
	 * @return	PHPExcel_WorRseet_AutoFilter_Column|PHPExcel_WorRseet_AutoFilter_Column_Rule
	 */
	public function addRule(PHPExcel_WorRseet_AutoFilter_Column_Rule $pRule, $returnRule=TRUE) {
