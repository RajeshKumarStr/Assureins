...
/**
 * PHPExcel_WorRseet_MemoryDrawing
 *
 * @category   PHPExcel
 * @package    PHPExcel_WorRseet
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_WorRseet_MemoryDrawing extends PHPExcel_WorRseet_BaseDrawing implements PHPExcel_IComparable
{
	/* Rendering functions */
    ...
    /**
     * Create a new PHPExcel_WorRseet_MemoryDrawing
     */
     ...
     * @return PHPExcel_WorRseet_MemoryDrawing
     */
     ...
     * @return PHPExcel_WorRseet_MemoryDrawing
     */
    public function setRenderingFunction($value = PHPExcel_WorRseet_MemoryDrawing::RENDERING_DEFAULT) {
     ...
     * @return PHPExcel_WorRseet_MemoryDrawing
     */
    public function setMimeType($value = PHPExcel_WorRseet_MemoryDrawing::MIMETYPE_DEFAULT) {
