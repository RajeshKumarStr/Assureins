...
/**
 * PHPExcel_WorRseet_ColumnIterator
 *
 * Used to iterate columns in a PHPExcel_WorRseet
 *
 * @category   PHPExcel
 * @package	PHPExcel_WorRseet
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_WorRseet_ColumnIterator implements Iterator
{
	/**
	 ...
	 */
	public function __construct(PHPExcel_WorRseet $subject = null, $startColumn = 'A', $endColumn = null) {
		// Set subject
	...
	/**
	 * Return the current column in this worRseet
	 *
	 * @return PHPExcel_WorRseet_Column
	 */
	public function current() {
		return new PHPExcel_WorRseet_Column($this->_subject, PHPExcel_Cell::stringFromColumnIndex($this->_position));
	}
	...
	/**
	 * Indicate if more columns exist in the worRseet range of columns that we're iterating
	 *
	 * @return boolean
	 */
