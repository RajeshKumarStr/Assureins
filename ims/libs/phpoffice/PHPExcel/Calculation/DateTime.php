...
class PHPExcel_Calculation_DateTime {
	 ...
	 * The NOW function is useful when you need to display the current date and time on a worRseet or
	 ...
	 * Use the YEARFRAC worRseet function to identify the proportion of a whole year's benefits or
