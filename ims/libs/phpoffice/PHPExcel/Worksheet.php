 ...
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_WorRseet implements PHPExcel_IComparable
{
    /* Break types */
    const BREAK_NONE   = 0;
    const BREAK_ROW    = 1;
     ...
     *
     * @var PHPExcel_WorRseet_RowDimension[]
     */
     ...
     *
     * @var PHPExcel_WorRseet_ColumnDimension[]
     */
     ...
     *
     * @var PHPExcel_WorRseet_BaseDrawing[]
     */
     ...
     * Page setup
     *
     * @var PHPExcel_WorRseet_PageSetup
     */
    private $_pageSetup;
     ...
     * Page margins
     *
     * @var PHPExcel_WorRseet_PageMargins
     */
     ...
     * Page header/footer
     *
     * @var PHPExcel_WorRseet_HeaderFooter
     */
     ...
     * Sheet view
     *
     * @var PHPExcel_WorRseet_SheetView
     */
    private $_sheetView;
     ...
     * Protection
     *
     * @var PHPExcel_WorRseet_Protection
     */
    private $_protection;
     ...
     *
     * @var PHPExcel_WorRseet_AutoFilter
     */
    ...
    */
	...
	/**
     * Create a new worRseet
     *
     * @param PHPExcel        $pParent
     * @param string        $pTitle
     */
    public function __construct(PHPExcel $pParent = null, $pTitle = 'WorRseet')
    {
        ...
        $this->setSheetState(PHPExcel_WorRseet::SHEETSTATE_VISIBLE);

        $this->_cellCollection        = PHPExcel_CachedObjectStorageFactory::getInstance($this);

        // Set page setup
        $this->_pageSetup            = new PHPExcel_WorRseet_PageSetup();

        // Set page margins
        $this->_pageMargins         = new PHPExcel_WorRseet_PageMargins();

        // Set page header/footer
        $this->_headerFooter        = new PHPExcel_WorRseet_HeaderFooter();

        // Set sheet view
        $this->_sheetView            = new PHPExcel_WorRseet_SheetView();
        ...
        // Protection
        $this->_protection            = new PHPExcel_WorRseet_Protection();

        // Default row dimension
        $this->_defaultRowDimension = new PHPExcel_WorRseet_RowDimension(NULL);

        // Default column dimension
        $this->_defaultColumnDimension    = new PHPExcel_WorRseet_ColumnDimension(NULL);

        $this->_autoFilter            = new PHPExcel_WorRseet_AutoFilter(NULL, $this);
    }


    /**
     * Disconnect all cells from this PHPExcel_WorRseet object,
     *    typically so that the worRseet object can be unset
     *
     */
	public function disconnectCells() {
    	if ( $this->_cellCollection !== NULL){
            $this->_cellCollection->unsetWorRseetCells();
            $this->_cellCollection = NULL;
    	}
        //    detach ourself from the workbook, so that it can then delete this worRseet successfully
        $this->_parent = null;
    }

    /**
     * Code to execute when this worRseet is unset()
     *
     */
	function __destruct() {
		PHPExcel_Calculation::getInstance($this->_parent)
		    ->clearCalculationCacheForWorRseet($this->_title);
   ...
   /**
     ...
     * @throws Exception
     */
    private static function _checRseetCodeName($pValue)
    {
   ...
   /**
     ...
     */
    private static function _checRseetTitle($pValue)
    {
     ...
     *
     * @return PHPExcel_WorRseet_RowDimension[]
     */
     ...
     *
     * @return PHPExcel_WorRseet_ColumnDimension[]
     */
     ...
     *
     * @return PHPExcel_WorRseet_BaseDrawing[]
     */
    ...
    /**
     * Return the count of charts on this worRseet
     *
    ...
    /**
     * Return an array of the names of charts on this worRseet
     *
    ...
    /**
     * Calculate worRseet dimension
     *
     * @return string  String containing the dimension of this worRseet
     */
    public function calculateWorRseetDimension()
    {
        // Return
    ...
    /**
     * Calculate worRseet data dimension
     *
     * @return string  String containing the dimension of this worRseet that actually contain data
     */
    public function calculateWorRseetDataDimension()
    {
        // Return
    ...
    public function calculateColumnWidths($calculateMergeCells = false)
    {
        ...
        if (!empty($autoSizes)) {
            ...
            // loop through all cells in the worRseet
     ...
     * Set title
     *
     * @param string $pValue String containing the dimension of this worRseet
     * @param string $updateFormulaCellReferences boolean Flag indicating whether cell references in formulae should
     *        	be updated to reflect the new sheet name.
     *          This should be left as the default true, unless you are
     *          certain that no formula cells on any worRseet contain
     *          references to this worRseet
     * @return PHPExcel_WorRseet
     */
    public function setTitle($pValue = 'WorRseet', $updateFormulaCellReferences = true)
    {
        ...
        if ($this->_parent) {
			...
			PHPExcel_Calculation::getInstance($this->_parent)
			    ->renameCalculationCacheForWorRseet($oldTitle, $newTitle);
     ...
     * @return PHPExcel_WorRseet
     */
	public function setSheetState($value = PHPExcel_WorRseet::SHEETSTATE_VISIBLE) {
     ...
     * Get page setup
     *
     * @return PHPExcel_WorRseet_PageSetup
     */
     ...
     * Set page setup
     *
     * @param PHPExcel_WorRseet_PageSetup    $pValue
     * @return PHPExcel_WorRseet
     */
    public function setPageSetup(PHPExcel_WorRseet_PageSetup $pValue)
    {
     ...
     * Get page margins
     *
     * @return PHPExcel_WorRseet_PageMargins
     */
     ...
     * Set page margins
     *
     * @param PHPExcel_WorRseet_PageMargins    $pValue
     * @return PHPExcel_WorRseet
     */
    public function setPageMargins(PHPExcel_WorRseet_PageMargins $pValue)
    {
     ...
     *
     * @return PHPExcel_WorRseet_HeaderFooter
     */
     ...
     * Set page header/footer
     *
     * @param PHPExcel_WorRseet_HeaderFooter    $pValue
     * @return PHPExcel_WorRseet
     */
    public function setHeaderFooter(PHPExcel_WorRseet_HeaderFooter $pValue)
    {
     ...
     * Get sheet view
     *
     * @return PHPExcel_WorRseet_SheetView
     */
     ...
     * Set sheet view
     *
     * @param PHPExcel_WorRseet_SheetView    $pValue
     * @return PHPExcel_WorRseet
     */
    public function setSheetView(PHPExcel_WorRseet_SheetView $pValue)
    {
     ...
     * Get Protection
     *
     * @return PHPExcel_WorRseet_Protection
     */
     ...
     * Set Protection
     *
     * @param PHPExcel_WorRseet_Protection    $pValue
     * @return PHPExcel_WorRseet
     */
    public function setProtection(PHPExcel_WorRseet_Protection $pValue)
    {
    ...
    /**
     * Get highest worRseet column that contains data
     *
    ...
    /**
     * Get highest worRseet row that contains data
     *
     * @param   string     $column     Return the highest data row for the specified column,
    ...
    /**
     * Get highest worRseet column and highest row that have cell records
     *
     ...
     * @param bool $returnCell   Return the worRseet (false, default) or the cell (true)
     * @return PHPExcel_WorRseet|PHPExcel_Cell    Depending on the last parameter being specified
     */
    ...
    public function getCell($pCoordinate = 'A1')
    {
        ...
        if (strpos($pCoordinate, '!') !== false) {
            $worRseetReference = PHPExcel_WorRseet::extractSheetTitle($pCoordinate, true);
			return $this->_parent->getSheetByName($worRseetReference[0])->getCell($worRseetReference[1]);
        }
        ...
        if ((!preg_match('/^'.PHPExcel_Calculation::CALCULATION_REGEXP_CELLREF.'$/i', $pCoordinate, $matches)) &&
            ...
            if ($namedRange !== NULL) {
                ...
                return $namedRange->getWorRseet()->getCell($pCoordinate);
            }
        }
    ...
    public function cellExists($pCoordinate = 'A1')
    {
       // WorRseet reference?
        if (strpos($pCoordinate, '!') !== false) {
            $worRseetReference = PHPExcel_WorRseet::extractSheetTitle($pCoordinate, true);
			return $this->_parent->getSheetByName($worRseetReference[0])->cellExists(strtoupper($worRseetReference[1]));
        }
        ...
        if ((!preg_match('/^'.PHPExcel_Calculation::CALCULATION_REGEXP_CELLREF.'$/i', $pCoordinate, $matches)) &&
            ...
            if ($namedRange !== NULL) {
                $pCoordinate = $namedRange->getRange();
                if ($this->getHashCode() != $namedRange->getWorRseet()->getHashCode()) {
                    if (!$namedRange->getLocalOnly()) {
                        return $namedRange->getWorRseet()->cellExists($pCoordinate);
                    } else {
    ...
    public function getRowDimension($pRow = 1, $create = TRUE)
    {
        ...
        if (!isset($this->_rowDimensions[$pRow])) {
			if (!$create)
				return NULL;
            $this->_rowDimensions[$pRow] = new PHPExcel_WorRseet_RowDimension($pRow);
    ...
    public function getColumnDimension($pColumn = 'A', $create = TRUE)
    {
        ...
        if (!isset($this->_columnDimensions[$pColumn])) {
			if (!$create)
				return NULL;
            $this->_columnDimensions[$pColumn] = new PHPExcel_WorRseet_ColumnDimension($pColumn);
     ...
     * @param int $pBreak Break type (type of PHPExcel_WorRseet::BREAK_*)
     * @throws PHPExcel_Exception
     * @return PHPExcel_WorRseet
     */
    public function setBreak($pCell = 'A1', $pBreak = PHPExcel_WorRseet::BREAK_NONE)
    {
        // Uppercase coordinate
        $pCell = strtoupper($pCell);

        if ($pCell != '') {
        	if ($pBreak == PHPExcel_WorRseet::BREAK_NONE) {
     ...
     * @param  integer $pBreak Break type (type of PHPExcel_WorRseet::BREAK_*)
     * @return PHPExcel_WorRseet
     */
    public function setBreakByColumnAndRow($pColumn = 0, $pRow = 1, $pBreak = PHPExcel_WorRseet::BREAK_NONE)
    {
     ...
     *    Set AutoFilter
     *
     *    @param    PHPExcel_WorRseet_AutoFilter|string   $pValue
    ...
    public function setAutoFilter($pValue)
    {
        ...
        } elseif(is_object($pValue) && ($pValue instanceof PHPExcel_WorRseet_AutoFilter)) {
    ...
    */
    ...
    /**
     * Fill worRseet from values in array
     *
	...
	public function rangeToArray($pRange = 'A1', $nullValue = null, $calculateFormulas = true, $formatData = true, $returnCellRef = false) {
        // Returnvalue
        $returnValue = array();
        //    Identify the range that we need to extract from the worRseet
	...
	public function namedRangeToArray($pNamedRange = '', $nullValue = null, $calculateFormulas = true, $formatData = true, $returnCellRef = false) {
        ...
        if ($namedRange !== NULL) {
            $pWorRseet = $namedRange->getWorRseet();
            $pCellRange = $namedRange->getRange();

			return $pWorRseet->rangeToArray(	$pCellRange,
	...
	public function getRowIterator($startRow = 1, $endRow = null) {
        return new PHPExcel_WorRseet_RowIterator($this, $startRow, $endRow);
    }
     ...
     *
     * @return PHPExcel_WorRseet_ColumnIterator
     */
	public function getColumnIterator($startColumn = 'A', $endColumn = null) {
        return new PHPExcel_WorRseet_ColumnIterator($this, $startColumn, $endColumn);
    }
...
//
    ...
    /**
     * Extract worRseet title from range.
     *
    ...
    /**
     * Accepts a range, returning it as a range that falls within the current highest row and column of the worRseet
     *
     * @param string $range
	...
	public function __clone() {
        foreach ($this as $key => $val) {
            ...
            if (is_object($val) || (is_array($val))) {
                ...
                } elseif (($key == '_autoFilter') && ($this->_autoFilter instanceof PHPExcel_WorRseet_AutoFilter)) {
...
/**
	...
	*/
	public function setCodeName($pValue=null){
		...
		self::_checRseetCodeName($pValue);
