...
class PHPExcel_CachedObjectStorage_Memcache extends PHPExcel_CachedObjectStorage_CacheBase implements PHPExcel_CachedObjectStorage_ICache {
	...
	/**
	 * Prefix used to uniquely identify cache data for this worRseet
	 *
	 * @var string
	 */
	 ...
	 * @return	void
	 */
	public function unsetWorRseetCells() {
		...
		//	detach ourself from the worRseet, so that it can then delete this object successfully
		$this->_parent = null;
	}	//	function unsetWorRseetCells()
	 ...
	 */
	public function __construct(PHPExcel_WorRseet $parent, $arguments) {
