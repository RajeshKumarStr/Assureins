...
class PHPExcel_Shared_Excel5
{
	 ...
	 *
	 * @param PHPExcel_WorRseet $sheet The sheet
	...
	*/
	 ...
	 */
	public static function getDistanceX(PHPExcel_WorRseet $sheet, $startColumn = 'A', $startOffsetX = 0, $endColumn = 'A', $endOffsetX = 0)
	{
		$distanceX = 0;
	 ...
	 */
	public static function getDistanceY(PHPExcel_WorRseet $sheet, $startRow = 1, $startOffsetY = 0, $endRow = 1, $endOffsetY = 0)
	{
		$distanceY = 0;
