...
class PHPExcel_Writer_HTML extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter {
	...
	public function generateSheetData() {
		...
		foreach ($sheets as $sheet) {
			...
			// Get worRseet dimension
			$dimension = explode(':', $sheet->calculateWorRseetDimension());
	...
	private function _extendRowsForChartsAndImages(PHPExcel_WorRseet $pSheet, $row) {
		$rowMax = $row;
		$colMax = 'A';
	 ...
	 *
	 * @param	PHPExcel_WorRseet	$pSheet			PHPExcel_WorRseet
	 * @param	string				$coordinates	Cell coordinates
	 * @return	string
	 * @throws	PHPExcel_Writer_Exception
	 */
	private function _writeImageInCell(PHPExcel_WorRseet $pSheet, $coordinates) {
		// Construct HTML
		$html = '';
	 ...
	 * @throws	PHPExcel_Writer_Exception
	 */
	private function _writeChartInCell(PHPExcel_WorRseet $pSheet, $coordinates) {
		// Construct HTML
		$html = '';
...
//		$css = $this->_mapBorderStyle($pStyle->getBorderStyle()) . ' #' . $pStyle->getColor()->getRGB();
	 ...
	 *
	 * @param	PHPExcel_WorRseet	$pSheet		The worRseet for the table we are writing
	 * @return	string
	 * @throws	PHPExcel_Writer_Exception
	 */
	 ...
	 * @throws	PHPExcel_Writer_Exception
	 */
	private function _generateRow(PHPExcel_WorRseet $pSheet, $pValues = null, $pRow = 0, $cellType = 'td') {
		if (is_array($pValues)) {
			// Construct HTML
			$html = '';
	...
	private function _setMargins(PHPExcel_WorRseet $pSheet) {
		$htmlPage = '@page { ';
		$htmlBody = 'body { ';
