...
class PHPExcel_Writer_Excel2007_Comments extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 */
	public function writeComments(PHPExcel_WorRseet $pWorRseet = null)
	{
		// Create XML writer
		$objWriter = null;
		...
		$objWriter->startDocument('1.0','UTF-8','yes');
  		...
  		// Comments cache
  		$comments	= $pWorRseet->getComments();
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	public function writeVMLComments(PHPExcel_WorRseet $pWorRseet = null)
	{
		// Create XML writer
		$objWriter = null;
		if ($this->getParentWriter()->getUseDiskCaching()) {
