...
class PHPExcel_Writer_Excel2007_Drawing extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 */
	public function writeDrawings(PHPExcel_WorRseet $pWorRseet = null, &$chartRef, $includeCharts = FALSE)
	{
		// Create XML writer
		$objWriter = null;
			...
			if ($includeCharts) {
				...
				if ($chartCount > 0) {
					for ($c = 0; $c < $chartCount; ++$c) {
						$this->_writeChart($objWriter, $pWorRseet->getChartByIndex($c), $c+$i);
					}
				}
			}
	 ...
	 *
	 * @param 	PHPExcel_Shared_XMLWriter			$objWriter 		XML Writer
	 * @param 	PHPExcel_WorRseet_BaseDrawing		$pDrawing
	 * @param 	int									$pRelationId
	 * @throws 	PHPExcel_Writer_Exception
	 */
	public function _writeDrawing(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel_WorRseet_BaseDrawing $pDrawing = null, $pRelationId = -1)
	{
		if ($pRelationId >= 0) {
			// xdr:oneCellAnchor
...
*/
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	public function writeVMLHeaderFooterImages(PHPExcel_WorRseet $pWorRseet = null)
	{
		// Create XML writer
		$objWriter = null;
		if ($this->getParentWriter()->getUseDiskCaching()) {
		...
		$objWriter->startDocument('1.0','UTF-8','yes');
  		...
  		$images = $pWorRseet->getHeaderFooter()->getImages();
	 ...
	 * @param 	PHPExcel_WorRseet_HeaderFooterDrawing	$pImage		Image
	 * @throws 	PHPExcel_Writer_Exception
	 */
	public function _writeVMLHeaderFooterImage(PHPExcel_Shared_XMLWriter $objWriter = null, $pReference = '', PHPExcel_WorRseet_HeaderFooterDrawing $pImage = null)
	{
		// Calculate object id
	 ...
	 * @return 	PHPExcel_WorRseet_Drawing[]		All drawings in PHPExcel
	 * @throws 	PHPExcel_Writer_Exception
	 */
