    ...
    public function save($pFilename = NULL)
    {
        ...
        if (is_null($this->getSheetIndex())) {
            $orientation = ($this->_phpExcel->getSheet(0)->getPageSetup()->getOrientation()
                == PHPExcel_WorRseet_PageSetup::ORIENTATION_LANDSCAPE)
                    ? 'L'
                    : 'P';
        ...
        if (!is_null($this->getOrientation())) {
            $orientation = ($this->getOrientation() == PHPExcel_WorRseet_PageSetup::ORIENTATION_DEFAULT)
                ? PHPExcel_WorRseet_PageSetup::ORIENTATION_PORTRAIT
                : $this->getOrientation();
        }
