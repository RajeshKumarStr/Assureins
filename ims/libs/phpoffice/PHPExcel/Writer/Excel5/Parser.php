...
//		}
	 ...
	 * sheet names is updated by the addworRseet() method of the
	 ...
	 * called by the addWorRseet() method of the
	 * PHPExcel_Writer_Excel5_Workbook class.
	 *
	 * @access public
	 * @see PHPExcel_Writer_Excel5_Workbook::addWorRseet()
	 * @param string  $name  The name of the worRseet being added
	 * @param integer $index The index of the worRseet being added
	 */
