...
<head>
    ...
    <title>Assure Online Insurance System</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="home.php">Assure Insurance</a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="area-heading">
                        ...
                        <p>Assure Online Insurance System is a web system which is used to tracking details on insurance policies, customer details and company details. The company tries to give insurance policy holders quick access to their insurance policy details, modify or update the datails and even renew an expired insurance policy. All this, with a single click on your computer, at the comfort of your home.</p>
                    </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="single-about">
                                ...
                                <div class="single-about-content">
                                    <h5>Easy Access</h5>
                                    <p>Assure Online Insurance System provides easy access and ease of use to our clients which makes our system reliable.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 mb-4 mb-xl-0 single-footer-widget">
                    ...
                    <div class="footer-logo">
                        <h3 style="color: white; font-weight: bolder">Assure Online Insurance System</h3>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6 mb-4 mb-xl-0 single-footer-widget">
                    ...
                    <div class="footer-address">
                        <p>Address : Coimbatore <br> Assure</p>
                        <span>Phone : +916379350559</span>
                        <span>Email : muthumuthuram7@gmail.com</span>
                    </div>
                </div>
